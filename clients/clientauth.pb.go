...
var fileDescriptor_b20557622d842476 = []byte{
	...
	0x14, 0x2b, 0xa5, 0x70, 0xf1, 0x38, 0x96, 0x96, 0x64, 0xe4, 0x17, 0x65, 0x56, 0xa5, 0x06, 0xa5,
	...
	0xb9, 0x44, 0x82, 0x19, 0x22, 0x92, 0x98, 0x5c, 0x22, 0x24, 0xc7, 0xc5, 0x95, 0x9a, 0x57, 0x92,
	0x59, 0x52, 0x19, 0x52, 0x59, 0x90, 0x2a, 0xc1, 0x02, 0x96, 0x40, 0x12, 0x51, 0xd2, 0x43, 0xb1,
	0xa5, 0x18, 0xa4, 0x3e, 0x11, 0xc6, 0x4f, 0x01, 0x5b, 0xc6, 0x11, 0x84, 0x24, 0x62, 0xe4, 0xc5,
	0xc5, 0x0d, 0x52, 0x1f, 0x9c, 0x5a, 0x54, 0x96, 0x99, 0x9c, 0x2a, 0x64, 0xcd, 0xc5, 0x09, 0xd7,
	0x2e, 0x24, 0xaa, 0x07, 0x75, 0xbb, 0x1e, 0xb2, 0xc3, 0xa5, 0xb0, 0x0a, 0x17, 0x2b, 0x31, 0x38,
	0x09, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e,
	0xcb, 0x31, 0x24, 0xb1, 0x81, 0xc3, 0xc0, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xb1, 0xb2, 0x81,
	0x61, 0x17, 0x01, 0x00, 0x00,
}
...
func (m *AuthorizeReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EntityType) > 0 {
		...
		i = encodeVarintClientauth(dAtA, i, uint64(len(m.EntityType)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Act) > 0 {
